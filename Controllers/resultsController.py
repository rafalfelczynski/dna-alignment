...
class ResultsController(QObject):
    ...
    def __init__(self, resultsWidget, dotplotReader, alignReader,
                 dotplotDeleter: IDotplotDeleter, alignDeleter: IAlignmentDeleter,
        ...
        self._dotplotDeleter = dotplotDeleter
        self._alignDeleter = alignDeleter
    ...
    def _removeDotplot(self, ids):
        self._dotplotDeleter.deleteDotplot(ids[0], ids[1])
    ...
    def _removeAlignment(self, ids):
        ...
        self._alignDeleter.deleteAlignment(ids[0], ids[1], scoring)
    ...
    def openDotplotWindow(self, dotp):
        ...
        tab.destroyed.connect(lambda: print("destroyed"))
