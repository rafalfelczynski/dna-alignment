...
"")
        ...
        sizePolicy1.setHeightForWidth(self.processBtn.sizePolicy().hasHeightForWidth())
        self.processBtn.setSizePolicy(sizePolicy1)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.fetchScoringBtn.sizePolicy().hasHeightForWidth())
        self.fetchScoringBtn.setSizePolicy(sizePolicy1)
        ...
        sizePolicy5.setHeightForWidth(self.selectSeqSecBtn.sizePolicy().hasHeightForWidth())
        self.selectSeqSecBtn.setSizePolicy(sizePolicy5)
